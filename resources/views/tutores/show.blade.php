...
<div class="block">
	...
	{!! Form::open(['route' => ['tutores.destroy', $tutor->id], 'method' =>'DELETE', 'id' => 'form-eliminar-tutor', 'onSubmit' => 'return confirm(\'\\u00bfEst\\u00e1 realmente seguro(a) de eliminar este registro?\')']) !!}
        ...
        <tbody>
            ...
            <tr>
				...
				<td>
					...
					<button type="button" id="eliminar" name="eliminar" class="btn btn-danger tooltip-error borrar" objeto="{{ $tutor->id }}"  onclick="return confirmSubmit(document.forms['form-eliminar-tutor'], '¿Está realmente seguro de eliminar este registro?');"><i class="icon-trash position-right"></i> Eliminar</button>
				</td>
			</tr>
			--}}
        </tbody>
