...
var webApp = function() {
    ...
    var handleSidebars = function(mode) {
        ...
        if (mode === 'init') {
            ...
            sLScroll.add(sRScroll).slimScroll({ height: sScrollHeight, color: '#fff', size: '3px', touchScrollStep: 750 });
            ...
            $('#sidebar-right').mouseleave(function(){ handleSidebars('close-right'); });
    ...
    var templateOptions = function() {
        ...
        /* Left sidebar mouse hover option */
        var leftSidebar = $('#sidebar-left');
        var optHoverEnable = $('#options-hover-enable');
        var optHoverDisable = $('#options-hover-disable');

        if (leftSidebar.hasClass('enable-hover')) {
            optHoverEnable.addClass('active');
        } else {
            optHoverDisable.addClass('active');
        }

        optHoverEnable.click(function() {
            leftSidebar.addClass('enable-hover');
            $(this).addClass('active');
            optHoverDisable.removeClass('active');
        });

        optHoverDisable.click(function() {
            leftSidebar.removeClass('enable-hover');
            $(this).addClass('active');
            optHoverEnable.removeClass('active');
        });
